...
const OTPVerification: React.FC<OTPVerificationProps> = ({
 ...
 // Single useEffect for handling timer initialization
 useEffect(() => {
   ...
   // Force start new timer if coming from signup (has email in query)
   if (emailFromQuery) {
     startTimer();
     return;
   }

   // Otherwise check for existing timer
   ...
   <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 p-4">
     <div className="flex w-full max-w-2xl mx-4">
       <div className="flex-1 flex items-center justify-center p-6 bg-white rounded-l-xl shadow-lg">
         <div className="w-60">
           <img src="/images/StudentLogin.png" alt="Student verification" className="w-full h-auto" />
         </div>
       </div>
       ...
       <div className="flex-1 p-6 bg-white rounded-r-xl shadow-lg">
         ...
         <p className="text-center text-gray-500 text-sm mb-6">We've sent a verification code to {email || 'your email'}</p>
