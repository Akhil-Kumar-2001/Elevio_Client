...
const CoursePreview = () => {
  ...
  const handleChatWithTutor = async () => {
    ...
    // toast.info("Chat functionality coming soon! Redirecting to chat interface...");
    // Example: router.push('/chat-with-tutor'); // Uncomment and adjust route as needed
      ...
      <div className="flex flex-col lg:flex-row w-full pt-16 flex-grow">
        <div className="lg:w-3/4 h-full flex flex-col">
          ...
          <div className="p-6 bg-white border-b">
            ...
            {/* Chat with Tutor Section */}
            {/* {hasPurchased() && (
              <div className="mt-4">
                <button
                  onClick={handleChatWithTutor}
                  className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md flex items-center w-full justify-center"
                >
