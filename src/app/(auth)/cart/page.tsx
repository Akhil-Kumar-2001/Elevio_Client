...
// import { useCartStore } from '@/store/cartCountStore';
...
//                 // No need to filter since all items should have course details
...
//                                                         ${item.price}
//                                                     </span>
//                                                     <button onClick={() => handleRemove(item.courseId)} className="text-red-600 hover:text-red-700 flex items-center">
...
//                                     </div>
//                                 </div>
//                                 <Link href={'/checkout'} className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 flex items-center justify-center">
