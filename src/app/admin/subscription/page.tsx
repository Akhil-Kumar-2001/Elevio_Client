...
import ConfirmModal from '@/components/admin/confirmModal'; // Adjust the path as needed
...
const Subscription = () => {
        ...
        if (window.confirm("Are you sure you want to delete this subscription plan?")) {
            try {
                ...
                if (result) {
                    ...
                    setSubscriptions(subscriptions.filter(sub => sub._id !== id)); // Change id to _id
                } else {
    ...
    const handleEditClick = (subscription: SubscriptionType) => {
        console.log('Editing subscription:', subscription); // Add this log
                                ...
                                subscriptions.map((subscription, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            {/* <button
                                                className="flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 rounded-md transition-colors"
                                                onClick={() => subscription._id ? handleDeleteClick(subscription._id) : null}
                                            >
                                                <Trash2 size={16} />
                                                Delete
                                            </button> */}
