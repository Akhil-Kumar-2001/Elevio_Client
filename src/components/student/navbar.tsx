...
//           className="text-gray-700 focus:outline-none mobile-menu-button"
...
//             <Link
//               href="/wishlist"
//               className="text-gray-700 hover:text-blue-500 flex items-center text-lg"
//               onClick={toggleMobileMenu}
//             >
//               <span>Wishlist</span>
//               {wishlistCount > 0 && (
...
//               </div>
//               {isDropdownOpen && (
//                 <div className="w-full bg-white border border-gray-300 rounded-md shadow-lg py-2 mt-2 z-50">
//                   <Link
//                     href={`/profile/${studentId}`}
//                     className="block px-4 py-2 text-gray-700 hover:bg-gray-100 text-lg text-center"
//                     onClick={(e) => {
//                       e.stopPropagation();
//                       setIsDropdownOpen(false);
//                       setIsMobileMenuOpen(false);
...
//                   </Link>
//                   <div
//                     className="block px-4 py-2 text-gray-700 hover:bg-gray-100 text-lg text-center cursor-pointer"
//                     onClick={(e) => {
//                       e.stopPropagation();
//                       handleLogout();
//                       setIsDropdownOpen(false);
...
import { useCartCountStore } from '@/store/cartCountStore';
import { toast } from 'react-toastify';
// Import Heroicons for navigation and profile
import {
  HomeIcon,
  BookOpenIcon,
  AcademicCapIcon,
