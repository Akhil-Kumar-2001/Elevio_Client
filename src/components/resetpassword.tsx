  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response) {
        ...
        const redirectPath = role === 'student' ? '/login' : '/tutor/login';
          ...
          <form onSubmit={handleSubmit} className="space-y-4 max-w-xs mx-auto w-full">
            <div className="relative">
              <motion.input
                ...
                className={`w-full px-3 py-2 bg-gray-50 text-gray-900 placeholder-gray-400 border-b-2 ${errors ? 'border-red-500' : 'border-gray-200 focus:border-teal-600'} focus:shadow-[0_0_12px_rgba(13,148,136,0.4)] outline-none transition-all duration-300 font-poppins text-sm pr-10`}
